...
class PlayViewController: RootViewController{
    ...
    func setBottomButton() -> Void{
        ...
        commitBtn.addTarget(self, action: #selector(commitAction), for: UIControl.Event.touchUpInside);
        ...
        collectBtn.addTarget(self, action: #selector(collectAction(_:)), for: UIControl.Event.touchUpInside);
        
        self.view.addSubview(collectBtn)
    
    }
    
    @objc func collectAction(_ button:UIButton) -> Void {
